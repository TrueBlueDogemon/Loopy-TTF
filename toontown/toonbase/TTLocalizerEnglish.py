...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
		   ...
		   'Your expenses are much too low!',
		   'You currently owe more than your Laff can handle.'],
 ...
 'BuzzWord': ['Pardon me if I drone on.',
			  ...
			  'Hmmm, this might sting after all.'],
 ...
 'ParadigmShift': ["Watch out! I'm rather shifty.",
				   ...
				   "Let's shift things around, shall we?"],
 'PeckingOrder': ["This one's for the birds.",
				  ...
				  'Time to bring down two Toons with one bird!'],
...
BattleGlobalTracks = ['toon-up',
 ...
 'squirt',
 'drop']
BattleGlobalNPCTracks = ['restock', 'toons hit', 'cogs miss', 'fire']
...
BrutalSellbotBossName = 'Chairman of the Cogs'
CashbotBossName = 'C. F. O.'
BrutalCashbotBossName = 'Chairman of the Cogs'
...
FishSpeciesNames = {0: ('Balloon Fish',
 ...
 8: ('Star Fish',
     ...
     'Shining Star Fish',
     'All Star Fish'),
 10: ('Holey Mackerel', 'Angelic Holey Mackerel', 'Lord Fish'),
 12: ('Dog Fish',
      'Bull Dog Fish',
      'Hot Dog Fish',
      'Dalmatian Dog Fish',
 ...
 26: ('Brown Bear Acuda',
      ...
      'Kodiac Bear Acuda',
      'Grizzly Bear Acuda'),
 28: ('Cutthroat Trout', 'Captain Cutthroat Trout', 'Scurvy Cutthroat Trout', 'Buccaneer Cutthroat Trout'),
 30: ('Piano Tuna',
      'Grand Piano Tuna',
